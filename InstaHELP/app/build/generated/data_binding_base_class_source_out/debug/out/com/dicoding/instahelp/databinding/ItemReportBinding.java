...
public final class ItemReportBinding implements ViewBinding {
  ...
  private ItemReportBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imgReport,
  ...
  public static ItemReportBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemReportBinding((ConstraintLayout) rootView, imgReport, tvDescription, tvTime,
          tvTitle);
    }
